...
//                startButton.performClick();
                ...
                if (mChangePosition) {
                    ...
                    bottomProgressBar.setProgress(progress+10000);
                    Toast.makeText(jzvdContext, "10+", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    protected void clickRetryBtn() {
        if (jzDataSource.urlsMap.isEmpty() || jzDataSource.getCurrentUrl() == null) {
            Toast.makeText(jzvdContext, "No Url Found", Toast.LENGTH_SHORT).show();
            return;
        }
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    public void changeUIToPreparingPlaying() {
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                Log.e(TAG, "changeUIToPreparingPlaying: " );
    ...
    public void changeUIToPreparingChangeUrl() {
        switch (screen) {
            case SCREEN_NORMAL:
            case SCREEN_FULLSCREEN:
                Log.e(TAG, "changeUIToPreparingChangeUrl: " );
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
                        View.VISIBLE, View.VISIBLE, View.INVISIBLE, View.INVISIBLE);
                updateStartImage();
                break;
