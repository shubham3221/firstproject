...
class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =LayoutInflater.from(context).inflate(R.layout.unused_collection_one_movies_recycler,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Picasso.get().load(col_one_list.get(position).getMainimg())
                .placeholder(R.drawable.search2)
...
//                .transform(new Croptransformation(500,540, Croptransformation.GravityHorizontal.CENTER, Croptransformation.GravityVertical.BOTTOM))
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView  = itemView.findViewById(R.id.img_c_1);
